# P23 checks: Define a Device Command and Telemetry Contract
...
- the learner can answer: “What inputs, observable effects, and failure modes matter when you define a Device Command and Telemetry Contract?” without relying on MATLAB syntax.
