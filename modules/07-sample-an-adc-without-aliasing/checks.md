# P07 checks: Sample an ADC Without Aliasing
...
- the learner can answer: “What inputs, observable effects, and failure modes matter when you sample an ADC Without Aliasing?” without relying on MATLAB syntax.
