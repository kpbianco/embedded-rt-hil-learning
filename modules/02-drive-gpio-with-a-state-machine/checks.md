# P02 checks: Drive GPIO with a State Machine
...
- the learner can answer: “What inputs, observable effects, and failure modes matter when you drive GPIO with a State Machine?” without relying on MATLAB syntax.
