# P22 checks: Replay an Input Deterministically
...
- the learner can answer: “What inputs, observable effects, and failure modes matter when you replay an Input Deterministically?” without relying on MATLAB syntax.
