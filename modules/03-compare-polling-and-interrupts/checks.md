# P03 checks: Compare Polling and Interrupts
...
- the learner can answer: “What inputs, observable effects, and failure modes matter when you compare Polling and Interrupts?” without relying on MATLAB syntax.
