# P18 checks: Detect a Stuck Sensor
...
- the learner can answer: “What inputs, observable effects, and failure modes matter when you detect a Stuck Sensor?” without relying on MATLAB syntax.
