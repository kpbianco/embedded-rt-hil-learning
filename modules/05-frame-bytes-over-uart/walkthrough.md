# P05 walkthrough: Frame Bytes over UART

## Planned learner sequence

1. Read the guiding question: What inputs, observable effects, and failure modes matter when you frame Bytes over UART?
